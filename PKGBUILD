...
#   1. Push to a public repo (e.g. GitHub)
#   2. Update source=() with the release tarball URL
#   3. Update sha256sums with the tarball hash
#   4. Optionally bump pkgver
...
optdepends=('kitty: native image display in kitty terminal'
            ...
            'jp2a: black & white ASCII art fallback'
...
sha256sums=('SKIP')
# ^ Replace SKIP with actual sha256sum before AUR submission
